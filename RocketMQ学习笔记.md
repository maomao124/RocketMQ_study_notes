...
<h1 style="color: #ff90fa;text-align: center;font-size:3em">RocketMQ学习笔记</h1>
...
![image-20221211234426275](img/RocketMQ学习笔记/image-20221211234426275.png)
...
![image-20221211234835652](img/RocketMQ学习笔记/image-20221211234835652.png)
...
rocketMQ是通过使用mmap的方式，可以省去向用户态的内存复制，提高速度。这种机制在Java中是通过MappedByteBuffer实现的
...
![image-20221211235051187](img/RocketMQ学习笔记/image-20221211235051187.png)
